const featuresNums = [
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={45} height={45} fill={"none"}>
    ...
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={45} height={45} fill={"none"}>
            ...
            <path d="M12.0082 8L11.9992 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>,
        rate: 83,
        text1: 'Reduce recruitment',
        text2: 'agency spend'
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={45} height={45} fill={"none"}>
