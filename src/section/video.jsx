        ...
        <section className='section py-20'>
            <div className="container m-auto">
                <div className="flex flex-col items-center">
                    <h2 className='text-3xl mb-4 font-bold'>Built exclusively for you</h2>
                    <p className='text-gray-500 mb-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi egestas Werat viverra id et aliquet. vulputate egestas sollicitudin.</p>
                    <div id='video-thumnail' className="relative w-full mt-4 rounded-md overflow-hidden">
                        <Image src={videoThumnail} className='w-full video-img' alt="videoThumnail" />
                        ...
                        {isplay && (
                            <iframe src="https://www.youtube.com/embed/dyZcRRWiuuw?autoplay=1&mute=1"
